...
namespace GrizzlyBear {
	...
	void Renderer::begin_frame(const glm::vec3& backgroundColor, Ref<FrameBuffer> buffer)
	{
		...
		m_Window->get_context()->set_clear_color({backgroundColor.r, backgroundColor.g, backgroundColor.b, 1.0f});
