...
namespace GrizzlyBear {
	...
	public:
		...
		struct SceneProps
		{
			...
			AmbientLight AMBIENT_LIGHT = { {1.0f, 1.0f, 1.0f, 1.0f}, 1.0f };
		};
	...
	public:
		...
		//Primitive
		void begin_scene(const SceneProps& props);
		...
		bool render_scene(Timestep ts, const Ref<Scene> scene, const SceneProps& custom);
