...
namespace GrizzlyBear {
	...
	using TableType = EntityTable<CompTransformation2D, CompTransformation3D, CompCamera, CompMesh2D, CompWidget, CompScript>;
	using CompManagerType = ComponentManager<CompTransformation2D, CompTransformation3D, CompCamera, CompMesh2D, CompWidget, CompScript>;
