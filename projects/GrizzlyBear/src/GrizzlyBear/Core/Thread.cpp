...
namespace GrizzlyBear {
	...
	*/
	ModuleState ThreadManager::init()
	{
		...
		try
		{
			...
			GRIZZLY_CORE_LOG(LogLevel::Trace, "Module: ThreadManager, Message: Initialization complete.");
			return ModuleState::GOOD;
		}
		catch (std::exception& e)
		{
			GRIZZLY_CORE_LOG(LogLevel::Error, "Module: ThreadManager, Message: {0}", e.what());
			return ModuleState::ERROR_RISKY;
		}
	}
